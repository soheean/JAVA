...
public class Myform extends JFrame implements MouseListener,ChangeListener{
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		xc1 tt1 = new xc1(num1/2);
		xc2 tt2 = new xc2(num1);
		tt1.start();
		tt2.start();
		/*
		for (i = 1;i<=num1;i++)
...
class xc1 extends Thread
{
	...
	public void run() {
		...
		for (i=0;i<ed;i++)
		{
			sum += i;
			temp = (int) (i/ed*100);
			form2.Myform.pgsb.setValue(temp);
			
		}
		form2.Myform.jt.setText(String.valueOf(sum));
...
class xc2 extends Thread
{
	...
	public void run() {
		...
		//form2.Myform.jt.setText(String.valueOf(sum2));
		form2.Myform.jt.setText(form2.Myform.jt.getText() + String.valueOf(sum2));
	}
}
